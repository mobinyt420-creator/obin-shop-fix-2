...
export const GOOGLE_SHEETS_WEBHOOK_URL = 
  ...
  "https://script.google.com/macros/s/AKfycbw216IALTpxTrWOw_pGvT_kd_tLIE7hFJYs8_LSt4zs2HoFhdGu-uKCAKm97WUcnz2z/exec";

export const SECRET_ADMIN_EMAIL = 
  process.env.NEXT_PUBLIC_SECRET_ADMIN_EMAIL || 
  "mobinyt420@gmail.com";
